...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    player_num=player_score%10
    opponent_num=(opponent_score//10)%10
    score=3*abs(player_num-opponent_num)
    if(score):
        return score
    else:
        return 1
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    sus_score_0=sus_update(0,score,opponent_score)
    sus_score_1=sus_update(1,score,opponent_score)
    sus_score_2=sus_update(2,score,opponent_score)
    if(sus_score_0>GOAL):
        return 0
    elif(sus_score_1>GOAL):
        return 1
    elif(sus_score_2>GOAL):
        return 2
